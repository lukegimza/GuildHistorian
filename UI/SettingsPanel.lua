...
function SettingsPanel:Init()
    -- Register with the game's Settings UI
    local category = Settings.RegisterCanvasLayoutCategory(UIParent, L["ADDON_NAME"])
    category.ID = ns.ADDON_NAME
    ns.settingsCategoryID = category.ID
    Settings.RegisterAddOnCategory(category)

    -- Build the inline settings panel for the embedded tab
